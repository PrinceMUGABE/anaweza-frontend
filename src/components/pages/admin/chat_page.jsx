    ...
    try {
      ...
      if (socket) {
        socket.send(JSON.stringify({
          ...
          caller_name: `${currentUser.first_name} ${currentUser.last_name}`
        }));
      }
            ...
            <div className="text-center">
              <div className="mb-4">
                ...
                <p className="text-gray-600">
                  {otherUser?.first_name} {otherUser?.last_name} is calling...
                </p>
              </div>
        ...
        <div className="flex items-center space-x-4">
          {currentUser?.role === "lawyer" && (
            <button
              ...
              disabled={isVideoCallActive || !hasVideoDevices}
              className="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-full disabled:opacity-50"
              title={hasVideoDevices ? "Start Video Call" : "No video devices available"}
            >
...
export default Admin_Chat_Page;