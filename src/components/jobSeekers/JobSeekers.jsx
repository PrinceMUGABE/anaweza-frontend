        ...
        {featuredSeekers.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredSeekers.map((seeker) => {
              ...
              return (
                <div key={seeker.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                  <div className="p-6">
                      ...
                      <div className="w-24 h-24 rounded-full mb-4 overflow-hidden border-2 border-gray-100 shadow-sm">
                        {seeker.custom_user?.profile_picture ? (
                          ...
                          <div className="w-full h-full bg-gradient-to-r from-blue-50 to-blue-100 flex items-center justify-center">
                            <span className="text-blue-700 text-2xl font-medium">{getInitials(seeker)}</span>
                          </div>
                        )}
                      </div>
                      
                      <h3 className="font-semibold text-lg text-gray-900">{formatFullName(seeker)}</h3>
                      <p className="text-blue-700 font-medium">{seeker.education_sector || seeker.education_level}</p>
                ...
                <div className="md:w-1/3 flex flex-col items-center">
                  ...
                  <div className="w-32 h-32 rounded-full mb-4 overflow-hidden border-4 border-gray-100 shadow">
                    {selectedSeeker.custom_user?.profile_picture ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-r from-blue-50 to-blue-100 flex items-center justify-center">
                        <span className="text-blue-700 text-5xl font-medium">{getInitials(selectedSeeker)}</span>
                      </div>
                    )}
                  </div>
