...
const Job_Seeker_FeaturedJobs = () => {
  ...
  useEffect(() => {
    ...
    }, 10000); // Auto-navigate every 10 seconds
  ...
  useEffect(() => {
    if (allJobs.length > 0) {
      ...
      setFeaturedJobs(allJobs.slice(startIndex, endIndex));
    }
  }, [currentPage, allJobs]);
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium">
                        {applicationStatus.type === 'success' ? 'Application Successful' : 'Application Error'}
                      </h3>
...
export default Job_Seeker_FeaturedJobs;